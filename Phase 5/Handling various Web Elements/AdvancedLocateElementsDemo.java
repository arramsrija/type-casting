...
staticvoid demoElementActionForTable(WebDriver driver) throws InterruptedException {
...
intcolumnCount = columnsNumber.size();
...
staticvoid demoElementActionForSelect(WebDriver driver) {
String baseUrl = "File:///C:\\Users\\lenovo\\Phase5\\hello-selenium\\src\\main\\resources\\test.html";
driver.get(baseUrl);
...
staticvoid demoXPathCSSSelector(WebDriver driver) {
String baseUrl = "File:///C:\\Users\\lenovo\\Phase5\\hello-selenium\\src\\main\\resources\\test.html";
driver.get(baseUrl);
